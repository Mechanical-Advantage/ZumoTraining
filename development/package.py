...
os.mkdir("temp")
no_package_warning = True
for project in projects:
    if not os.path.exists(os.path.join(project, project + ".zip")):
        ...
        # Finish
        no_package_warning = False
        print("Packaged \"" + project + "\"")

# Remove temp directory
shutil.rmtree("temp")

# Warn if nothing packaged
if no_package_warning:
    print("No projects were packaged. Delete a zip to recreate it.")
